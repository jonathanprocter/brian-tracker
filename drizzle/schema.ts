...
export const entries = mysqlTable("entries", {
  ...
  index("entries_userId_idx").on(table.userId),
  index("entries_completedAt_idx").on(table.completedAt),
  index("entries_userId_completedAt_idx").on(table.userId, table.completedAt),
]);
...
export const userAchievements = mysqlTable("userAchievements", {
  ...
  index("userAchievements_userId_achievementId_idx").on(table.userId, table.achievementId),
]);
...
export const loginActivity = mysqlTable("loginActivity", {
  ...
  index("loginActivity_loggedInAt_idx").on(table.loggedInAt),
]);
